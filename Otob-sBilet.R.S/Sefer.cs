...
//sefer modulu
    public abstract class Sefer : IRezervasyon
    {
        ...
        public DateTime Tarih { get; set; } // Sefer tarihi eklendi

        public Sefer(string nereden, string nereye, DateTime? tarih = null)
        {
            Nereden = nereden;
            Nereye = nereye;
            Otobus = new Otobus(30); 
            Tarih = tarih ?? DateTime.Now; // Varsayılan olarak şimdi
        }
